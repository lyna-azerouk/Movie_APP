...
public class MovieDBServlet extends HttpServlet {
    ...
    private static final String API_URL = "https://api.themoviedb.org/3/movie/popular?api_key=" + API_KEY + "&language=fr-FR";
